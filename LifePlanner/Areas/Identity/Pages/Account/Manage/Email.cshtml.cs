    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await emailHelper.SendEmailAsync(Input.NewEmail, callbackUrl);

                StatusMessage = "Link za potvrdu je poslan na novi mail. Ako email ne dođe, kontaktirajte administratora na lifeplannerdemo@gmail.com";
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            var callbackUrl = Url.Page(
                ...
                protocol: Request.Scheme);
            EmailHelper emailHelper = new EmailHelper();
            await emailHelper.SendEmailAsync(email, callbackUrl);
